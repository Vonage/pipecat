...
### Option 1: Run with Python
    ...
    ```sh
    # Make sure your virtualenv is active and you are inside examples/vonage-speech-to-speech
    python server.py
    ```
...
1. Follow the instructions in: `examples/vonage-speech-to-speech/client/README.md`.
